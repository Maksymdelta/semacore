...
$.idealforms.i18n.uk = {
  ...
  errors: {
    ...
    digits: 'Повинні бути тільки цифри',
    name: 'Мінімум 3 букви',
    email: 'Повинен бути коректний email',
    username: 'Повинно складатись з мінімум 4 символів',
    pass: 'Должен быть длиной минимум в 6 символов, включать минимум одну цифру, одну большую букву и одну маленькую букву',
    ...
    min: 'Debe contener al menos {0} caracteres',
    max: 'No puede contener más de {0} caracteres',
    minoption: 'Selecciona al menos {0} opciones',
    maxoption: 'No puede haber más de {0} opciones seleccionadas',
    minmax: 'Debe contener al menos {0} pero no más de {1} caracteres',
    select: 'Selecciona una opción',
    extension: 'Выберите файлы с одним из расширений ({*})',
